			...
			<div class="section-inner">
					...
					<div class="categories">
						...
						<div class="ctg-rows">
							...
							<i class="far fa-folder"></i>
			           		<a class="category-name"  href="index.php?key=<?php echo $row->category; ?>"><?php echo $row->category; ?></a>
			           		</div>
				...
				<div class="right-side">
						...
						<div class="materials-table">
							...
							$items=$db->query("SELECT * FROM item b LEFT OUTER JOIN users u ON b.user_id=u.id  order by b.id DESC LIMIT $skip,$limit");
